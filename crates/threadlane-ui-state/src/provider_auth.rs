...
pub fn connect_github_cli(tx: Sender<ProviderAuthEvent>) -> Result<(), String> {
...
pub fn save_github_pat(token: &str, tx: Sender<ProviderAuthEvent>) -> Result<(), String> {
...
pub fn disconnect_gitlab() -> Result<(), String> {
...
pub fn test_antigravity_connection(tx: Sender<ProviderAuthEvent>) -> Result<(), String> {
    let _ = tx.send(ProviderAuthEvent::Status(
...
pub fn test_opencode_connection(
    key: &str,
    tx: Sender<ProviderAuthEvent>,
) -> Result<(), String> {
