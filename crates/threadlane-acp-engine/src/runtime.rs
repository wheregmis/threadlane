...
//!
//! `threadlane-acp` owns the protocol and `crate::bridge` owns the mapping
...
pub struct AcpTurnToolActivity {
...
pub struct AcpTurnOutcome {
    ...
    pub reply: String,
    pub tools: Vec<AcpTurnToolActivity>,
...
impl AcpEngine {
    ...
    pub fn has_pending_turn(&self, agent_id: &str) -> bool {
        self.active
            .as_ref()
    ...
    async fn ensure_session(
        ...
        let handler = crate::session_workspace_client(self.work_dir.clone())
...
) -> threadlane_acp::AcpPermissionResponder {
