...
pub fn available_models_for_project(
...
pub fn supports_reasoning(model_id: &str, project_root: Option<&std::path::Path>) -> bool {
...
pub fn selection_label(model_id: &str, available: &[ModelOption]) -> String {
    available
        .iter()
        .find(|model| model.id == model_id)
